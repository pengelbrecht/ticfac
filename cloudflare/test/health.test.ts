...
describe("health route", () => {
  ...
  it("reports every binding as present", async () => {
    ...
    // submission — SANDBOXES especially, which is the binding a live
    // deployment shipped without: every run was refused by a message naming
    // a remedy (`tk factory deploy`) that could not supply what the bundle
    // never declared.
