...
- Do not rewrite the epic's plan and do not open new scope. If the epic is not
  ...
  bundle — is a typed `findings` block in your report (see the implement-tick
  profile for the format), not prose and not a tracker write: it is drafted
  for the orchestrator mechanically, and your report is where it starts.
