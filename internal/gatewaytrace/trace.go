...
// PageSize mirrors GATEWAY_LOG_MAX_PAGE_SIZE in ticfac/cloudflare/src/gateway.ts:
...
// MaxPages mirrors MAX_LOG_PAGES in ticfac/cloudflare/src/gateway.ts. Reaching it
...
// ticfac/cloudflare/src/gateway.ts sends, and trace_test.go pins them together.
