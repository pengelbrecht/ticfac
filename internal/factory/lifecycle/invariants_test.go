...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — hardStopTrip,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — observe, renewRunLease,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — WAVE_LEG_MS,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — MIN_POLL_MS, MAX_POLL_MS,
...
// TICKS_KEEPER_INTERVAL) for the timer, and in ticfac/cloudflare/src/progress.ts
...
//
// Lives today in ticfac/cloudflare/src/reconcile.ts — reconcileWave,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — readWaveRequest,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — finalize (which ALWAYS
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — leaseLostTrip,
...
// ticfac/cloudflare/src/run-workflow.ts (acquireContext, planSandboxGit,
...
//
// Lives today in ticfac/cloudflare/src/ci-remediation.ts — strikeBudget,
...
//
// Lives today in ticfac/cloudflare/src/run-workflow.ts — boundedBudget, runConfig,
...
// all four fields), with ticfac/cloudflare/src/pr-review.ts's reviewEvidence and
