...
// firstLine is the first line of an HTTP error body, for error messages that
// quote what the server actually said (moved from ticks' setup.go with this
// file — setup.go keeps its own copy until it moves in ticks tick b3a).
