...
// transcribed from herdr-kinds.md (this package's copy — beside the roles and
// tiers tables since the config split) — the full-auto template, the
// model/effort translation, the accepted model family and the accepted effort
// levels.
//
...
type kindSpec struct {
	...
	// live. A kind without a verified template gets a warning rather than an
	// invented one — the rule herdr-kinds.md states as "do not assume a
	// template for a kind nobody has round-tripped".
