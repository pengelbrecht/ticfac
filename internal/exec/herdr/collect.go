...
func (e *Executor) CollectDetail(h *subprocess.JobHandle) (*subprocess.Collection, error) {
	...
	verdict, outcome, class, reason := classify(commits, hasReport, report, violations, artifactViolations, cancelled, agentGone)
...
func classify(commits int, hasReport bool, report subprocess.Report,
	violations, artifactViolations []string, cancelled, agentGone bool) (verdict, outcome, class, reason string) {
